...
int SDL_main(int argc, char *argv[])
{
    ...
    window = SDL_CreateWindow("ITU Language Test",
    ...
    ituFtInit();
    ituFtLoadFont(0, CFG_PRIVATE_DRIVE ":/font/NotoSansArabic-CondensedMedium.ttf", ITU_GLYPH_8BPP);//WenQuanYiMicroHeiMono

    // load itu file
    tick = SDL_GetTicks();

    ituSceneInit(&scene, NULL);
    ituSceneLoadFile(&scene, CFG_PRIVATE_DRIVE ":/language.itu");
