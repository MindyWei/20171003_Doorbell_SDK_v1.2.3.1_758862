...
extern bool videoViewTrackBarOnChanged(ITUWidget* widget, char* param);
...
extern bool monitorLayerOnEnter(ITUWidget* widget, char* param);
extern bool monitorLayerOnLeave(ITUWidget* widget, char* param);
extern bool monitorLayerOnTimer(ITUWidget* widget, char* param);
extern bool monitorRecButtonOnPress(ITUWidget* widget, char* param);
extern bool monitorSnapshotButtonOnPress(ITUWidget* widget, char* param);
extern bool monitorSwitchButtonOnPress(ITUWidget* widget, char* param);
extern bool monitorOpendoorButtonOnPress(ITUWidget* widget, char* param);
...
ITUActionFunction actionFunctions[] =
{
    ...
    "videoViewTrackBarOnChanged", videoViewTrackBarOnChanged,
    ...
    "monitorRecButtonOnPress", monitorRecButtonOnPress,
    "monitorSnapshotButtonOnPress", monitorSnapshotButtonOnPress,
    "monitorSwitchButtonOnPress", monitorSwitchButtonOnPress,
    "monitorOpendoorButtonOnPress", monitorOpendoorButtonOnPress,
